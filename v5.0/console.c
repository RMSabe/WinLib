...
/*
	WARNING: READ THIS IF YOU'RE BUILDING A DLL:

	This console library uses static variables for storing stdio handles as well as event function pointers.
	If you're building a DLL (Dynamic Link Library) file, it is extremely NOT recommended that you use this console library.
*/

#include "console.h"
#include "cstrdef.h"

__declspec(align(PTR_SIZE_BYTES)) HANDLE _h_console_stdin = INVALID_HANDLE_VALUE;
__declspec(align(PTR_SIZE_BYTES)) HANDLE _h_console_stdout = INVALID_HANDLE_VALUE;
__declspec(align(PTR_SIZE_BYTES)) HANDLE _h_console_stderr = INVALID_HANDLE_VALUE;

__declspec(align(PTR_SIZE_BYTES)) VOID *_p_console_on_key_event = NULL;
__declspec(align(PTR_SIZE_BYTES)) VOID *_p_console_on_mouse_event = NULL;
__declspec(align(PTR_SIZE_BYTES)) VOID *_p_console_on_window_buffer_size_event = NULL;
