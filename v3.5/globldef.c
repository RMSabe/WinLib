...
__declspec(align(PTR_SIZE_BITS)) const ULONG_PTR PTR_MAX_VALUE = ~((ULONG_PTR) 0u);
__declspec(align(PTR_SIZE_BITS)) const ULONG_PTR PTR_MSB_VALUE = (((ULONG_PTR) 1u) << (PTR_SIZE_BITS - 1u));

__declspec(align(PTR_SIZE_BITS)) HINSTANCE p_instance = NULL;
__declspec(align(PTR_SIZE_BITS)) HANDLE p_processheap = NULL;

__declspec(align(PTR_SIZE_BITS)) TCHAR textbuf[TEXTBUF_SIZE_CHARS] = {'\0'};
