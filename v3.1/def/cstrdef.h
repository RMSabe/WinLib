...
//!!!DEPRECATED!!!
//The following function "cstr_copy()" still works fine,
//but it's unnecessary as it can be replaced by
//__SPRINTF(output_str, bufferout_length, TEXT("%s"), input_str).
//It will probably be removed in future versions.
