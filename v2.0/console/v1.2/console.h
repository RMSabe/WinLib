...
extern BOOL WINAPI console_stdin_read(TCHAR *buffer, SIZE_T length);
...
//Returns TRUE if successful, FALSE otherwise.
extern BOOL WINAPI console_get_title(TCHAR *buffer, SIZE_T buffer_length, SIZE_T *p_title_length);
