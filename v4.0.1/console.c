...
static __declspec(align(PTR_SIZE_BYTES)) HANDLE _h_console_stdin = INVALID_HANDLE_VALUE;
static __declspec(align(PTR_SIZE_BYTES)) HANDLE _h_console_stdout = INVALID_HANDLE_VALUE;
static __declspec(align(PTR_SIZE_BYTES)) HANDLE _h_console_stderr = INVALID_HANDLE_VALUE;

static __declspec(align(PTR_SIZE_BYTES)) VOID *_p_console_on_key_event = NULL;
static __declspec(align(PTR_SIZE_BYTES)) VOID *_p_console_on_mouse_event = NULL;
static __declspec(align(PTR_SIZE_BYTES)) VOID *_p_console_on_window_buffer_size_event = NULL;

static BOOL WINAPI _console_read(HANDLE h_input, TCHAR *p_buffer, SIZE_T length);
static BOOL WINAPI _console_write(HANDLE h_output, const TCHAR *text);
static BOOL WINAPI _console_peek_stdin_record(INPUT_RECORD *p_input_record_struct_array, DWORD array_length, DWORD *p_structswritten);
static BOOL WINAPI _console_read_stdin_record(INPUT_RECORD *p_input_record_struct_array, DWORD array_length, DWORD *p_structswritten);
static BOOL WINAPI _console_key_pressed(BOOL peek, BOOL specific, WORD specific_virtual_key_code);
