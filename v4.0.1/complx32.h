...
__EXTERNC__ BOOL WINAPI complex32_get_conjugate(const complex32_t *p_input, complex32_t *p_output);
__EXTERNC__ BOOL WINAPI complex32_add(const complex32_t *p_input1, const complex32_t *p_input2, complex32_t *p_output);
__EXTERNC__ BOOL WINAPI complex32_subtract(const complex32_t *p_input1, const complex32_t *p_input2, complex32_t *p_output);
__EXTERNC__ BOOL WINAPI complex32_multiply(const complex32_t *p_input1, const complex32_t *p_input2, complex32_t *p_output);
__EXTERNC__ BOOL WINAPI complex32_divide(const complex32_t *p_input1, const complex32_t *p_input2, complex32_t *p_output);
