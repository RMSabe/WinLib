...
__EXTERNC__ BOOL WINAPI console_init(VOID);

/*Closes console stdin, stdout and stderr handlers.*/

__EXTERNC__ VOID WINAPI console_deinit(VOID);
...
__EXTERNC__ BOOL WINAPI console_stdin_read(TCHAR *p_buffer, SIZE_T length);
__EXTERNC__ BOOL WINAPI console_stdout_write(const TCHAR *text);
__EXTERNC__ BOOL WINAPI console_stderr_write(const TCHAR *text);
...
__EXTERNC__ BOOL WINAPI console_stdin_readcmd(TCHAR *p_buffer, SIZE_T length);
...
__EXTERNC__ BOOL WINAPI _console_set_color(BYTE color);
__EXTERNC__ INT WINAPI _console_get_color(VOID);
...
__EXTERNC__ BOOL WINAPI console_set_foreground_color(BYTE foreground_color);
__EXTERNC__ INT WINAPI console_get_foreground_color(VOID);

__EXTERNC__ BOOL WINAPI console_set_background_color(BYTE background_color);
__EXTERNC__ INT WINAPI console_get_background_color(VOID);
...
__EXTERNC__ BOOL WINAPI console_get_title(TCHAR *p_buffer, SIZE_T buffer_length, SIZE_T *p_title_length);
__EXTERNC__ BOOL WINAPI console_set_title(const TCHAR *title);
...
__EXTERNC__ BOOL WINAPI console_get_current_dimensions(SHORT *p_width, SHORT *p_height);
...
__EXTERNC__ INT WINAPI console_get_current_size_chars(VOID);
...
__EXTERNC__ BOOL WINAPI console_get_current_window_dimensions(SHORT *p_width, SHORT *p_height);
...
__EXTERNC__ INT WINAPI console_get_current_window_size_chars(VOID);
...
__EXTERNC__ BOOL WINAPI console_get_cursor_position(SHORT *p_xpos, SHORT *p_ypos);
__EXTERNC__ BOOL WINAPI console_set_cursor_position(SHORT xpos, SHORT ypos);
...
__EXTERNC__ BOOL WINAPI console_fill_screen_chars(TCHAR fill_char, SHORT xstart, SHORT ystart, DWORD length_chars);
...
__EXTERNC__ BOOL WINAPI _console_fill_screen_color(BYTE color, SHORT xstart, SHORT ystart, DWORD length_chars);
__EXTERNC__ BOOL WINAPI console_fill_screen_color(BYTE foreground, BYTE background, SHORT xstart, SHORT ystart, DWORD length_chars);
...
__EXTERNC__ BOOL WINAPI console_clear_text(VOID);
...
__EXTERNC__ BOOL WINAPI console_clear_screen(VOID);
...
__EXTERNC__ BOOL WINAPI console_wait_keypress(const TCHAR *text);
...
__EXTERNC__ BOOL WINAPI console_peek_key_pressed(VOID);
__EXTERNC__ BOOL WINAPI console_get_key_pressed(VOID);
...
__EXTERNC__ BOOL WINAPI console_peek_specific_key_pressed(WORD virtual_key_code);
__EXTERNC__ BOOL WINAPI console_get_specific_key_pressed(WORD virtual_key_code);
...
__EXTERNC__ VOID WINAPI console_set_input_event_handlers(VOID (WINAPI *on_key_event)(KEY_EVENT_RECORD*), VOID (WINAPI *on_mouse_event)(MOUSE_EVENT_RECORD*), VOID (WINAPI *on_window_buffer_size_event)(WINDOW_BUFFER_SIZE_RECORD*));
...
__EXTERNC__ BOOL WINAPI console_manage_input_events(VOID);
